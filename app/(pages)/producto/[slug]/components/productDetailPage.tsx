...
export default function ProductDetailPage({product}:{product:Product}){
    ...
    <div className="max-w-screen-xl px-4 mx-auto 2xl:px-0 flex h-[100%]">
      <div className="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">

        <div className="shrink-0 max-w-md lg:max-w-lg mx-auto flex justify-center">
          <img className="w-4/4 h-3/4 object-cover" src={`${process.env.NEXT_PUBLIC_API_URL}${product.productImage[0].url}`} alt="" />
          </div>
        ...
        <div className="mt-6 sm:mt-8 lg:mt-0">
          ...
          <div className="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
            ...
            <a
              href="#"
              title=""
              className="text-white mt-4 sm:mt-0 bg-blue-600 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-950 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center"
              role="button"
            >
              <svg
                className="w-5 h-5 -ms-2 me-2"
